...
const page = ({ params }) => {
     ...
     const getReportData = async () => {
          try {
               ...
               const response = await fetch(`${process.env.BASE_PROTOCOL}${process.env.BASE_URL}/api/report/monitoring/${decodeURIComponent(params.device_Id)}/${date}`)
          ...
          <div className="w-full h-screen bg-secondary p-10">
               ...
               <div className="py-5">
                    <table className="w-1/2">
                         ...
                         <tr>
                              <th >Type</th>
                              <th className='px-5 '>Monitoring</th>
                         </tr>
                         <tr>
                              <th >Date</th>
               ...
               <div className='w-full h-max overflow-scroll'>
                    <table
                         className=' w-full h-max overflow-x-scroll  block sm:table '>
                         <tr className='text-secondary'>
                              <th className='border-none bg-main rounded-tl-md'>Timestamp</th>
                              <th className='border-none bg-main'>Daya</th>
                              <th className='border-none bg-main'>Tegangan</th>
                              <th className='border-none bg-main'>Arus</th>
                              <th className='border-none bg-main rounded-tr-md'>Baterai</th>
                         </tr>
                         {
